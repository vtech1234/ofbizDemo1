...
public class OfbizDemoServices {
    ...
    public static Map<String, Object> createOfbizDemo(DispatchContext dctx, Map<String, ? extends Object> context) {
        ...
        try {
            ...
            ofbizDemo.setNextSeqId();// Auto generating next sequence of ofbizDemoId primary key
            ...
            Debug.log("==========This is my first Java Service implementation in Apache OFBiz. OfbizDemo " +
                    "record created successfully with ofbizDemoId: "+ofbizDemo.getString("ofbizDemoId"));
